...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = SenhaAdapter(this, R.layout.listagem, senhaList)
        ...
        addButton.setOnClickListener {
            val intent = Intent(this@MainActivity, NovaSenha::class.java)
        ...
        listView.setOnItemClickListener { _, _, position, _ ->
            ...
            val intent = Intent(this@MainActivity, EditarSenha::class.java)
